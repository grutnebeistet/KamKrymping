...
//    private final boolean using_android_l;
    ...
    private Resources getResources() { return cameraSurface.getView().getResources(); }
    ...
    public void setupCamera(boolean take_photo) {
        ...
        if( do_startup_focus && camera_controller.supportsAutoFocus() ) {
    ...
    public VideoProfile getVideoProfile() {
        ...
        if(record_audio && ContextCompat.checkSelfPermission(getContext(), Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED ) {
...
//            else if( fps_value.equals("default") && preview_too_dark ) { TODO kan ikke være true
...
//        return true;
//    } // TODO alltid true -> slett alle sjekker
